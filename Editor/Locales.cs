        ...
        private static void Initialize()
        {
            Gettext.SetLocalizedTexts(localizedTexts: new Dictionary<string, IDictionary<string, string>> {
                { "ja", new Dictionary<string, string> {
                    { "The conversion from VRM to VRChat avatar is not supported by VRChat SDK2.", "VRMからVRChatアバターへの変換は、VRChat SDK2に対応していません。" },
                    ...
                    { "The “PhysBones Simulated Bone Count” is {0}.",
                        "「PhysBones Simulated Bone Count」(VRCPhysBoneで揺れるボーンの数) が{0}です。" },
                    { "The “PhysBones Colliders” is {0}.",
                        "「PhysBones Colliders」(VRCPhysBoneColliderコンポーネントの数) が{0}です。" },
                    { "The “PhysBones Collision Check Count” is {0}.",
                        "「PhysBones Collision Check Count」(VRCPhysBoneで揺れるボーンの数×VRCPhysBoneColliderの数) が{0}です。" },
                    { "If this value exceeds {0}, the Quest default user setting disable all VRCPhysBones.",
                        "この値が{0}を超えていると、Questのデフォルトのユーザー設定ではすべてのVRCPhysBoneが無効化されます。" },
